...
var ast = (0, _remark2.default)().use(_remarkSlug2.default).run((0, _remark2.default)().parse(_content2.default));
...
_fs2.default.writeFileSync(target, template.substring(0, startIdx) + _server2.default.renderToString(_react2.default.createElement(_app2.default, { ast: ast, content: _content2.default, __self: undefined
