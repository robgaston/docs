...
var languageOptions = ['cURL', 'CLI', 'Python', 'JavaScript'];
var defaultLanguage = 'cURL';
...
var App = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'container unlimiter', __self: this
      },
      !col1 && !queryMatches.mobile && _react2.default.createElement(
        'div',
        { className: 'fixed-top fixed-right ' + (queryMatches.desktop && 'space-left16'), __self: this
        },
        _react2.default.createElement('div', { className: 'fill-light col6 pin-right', __self: this
        })
      ),
      queryMatches.desktop && _react2.default.createElement(
        'div',
        { className: 'space-top5 scroll-styled pad1 width16 sidebar fixed-left fill-dark dark', __self: this
        },
      ...
      _react2.default.createElement(
        'div',
        { className: '' + (queryMatches.desktop && 'space-left16'), __self: this
        },
        _react2.default.createElement(
          'div',
          { className: col1 ? 'col8 margin1' : '', __self: this
          },
          _react2.default.createElement(_content2.default, {
            ...
            ast: ast,
            language: this.state.language.toLowerCase(), __self: this
          })
        )
      ),
      _react2.default.createElement(
        'div',
        { className: 'fixed-top ' + (queryMatches.desktop && 'space-left16'), __self: this
        },
        _react2.default.createElement(
          'div',
          { className: 'events fill-light bottom-shadow pad1 ' + (col1 ? '' : 'col6 pin-topright') + ' ' + (queryMatches.tablet ? 'dark fill-blue' : '') + ' ' + (queryMatches.mobile ? 'space-top5 fixed-topright' : ''), __self: this
          },
          _react2.default.createElement(
            'div',
            { className: 'space-right1 small quiet inline', __self: this
            },
            'Show examples in:'
          ),
          _react2.default.createElement(_rounded_toggle2.default, {
            ...
            active: this.state.language, __self: this
          }),
          _react2.default.createElement(
            'div',
            { className: 'fr pad0', __self: this
            },
            queryMatches.desktop ? _react2.default.createElement('a', {
              title: 'Display as ' + (col1 ? 2 : 1) + ' column',
              onClick: this.toggleColumnMode,
              style: { cursor: 'pointer' },
              className: 'icon quiet caret-' + (col1 ? 'right' : 'left') + ' pad0 fill-darken0 round', __self: this
            }) : null
          )
        )
      ),
      _react2.default.createElement(
        'div',
        { className: 'fill-dark dark bottom-shadow fixed-top ' + (queryMatches.tablet ? 'pad1y pad2x col6' : 'pad0 width16'), __self: this
        },
        _react2.default.createElement('a', { href: '/', className: 'active space-top1 space-left1 pin-topleft icon round dark pad0 ' + _custom.brandClasses, __self: this
        }),
        _react2.default.createElement(
          'div',
          { className: 'strong small pad0\n          ' + (queryMatches.mobile ? 'space-left3' : '') + '\n          ' + (queryMatches.tablet ? 'space-left2' : 'space-left4 line-height15'), __self: this
          },
        ...
        queryMatches.tablet && _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            {
              ...
              className: 'short quiet pin-topright button rcon ' + (showNav ? 'caret-up' : 'caret-down') + ' space-right1 space-top1', __self: this
            },
            _react2.default.createElement(
              'span',
              { className: 'micro', __self: this
              },
              activeSection
            )
          ),
          showNav && _react2.default.createElement(
            'div',
            {
              className: 'fixed-left keyline-top fill-dark pin-left col6 pad2 scroll-styled space-top5', __self: this
            },
            _react2.default.createElement(_navigation2.default, {
              navigationItemClicked: this.navigationItemClicked,
              activeSection: activeSection,
