...
var Navigation = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'pad0x small', __self: this
      },
        ...
        if (child.depth === 1) {
          return _react2.default.createElement(
            ...
            { key: i,
              ...
              className: 'small pad0x quiet space-top1', __self: _this
            },
            sectionName
          );
          ...
          return _react2.default.createElement(_navigation_item2.default, {
            ...
            active: active,
            sectionName: sectionName, __self: _this
          });
          ...
          if (activeHeadings.hasOwnProperty(sectionName)) {
            return _react2.default.createElement(
              ...
              {
                key: i,
                className: 'space-left1', __self: _this
              },
      ...
      _react2.default.createElement(
        'a',
        { href: '/', className: 'space-top2 pad1y dark keyline-top block small quiet', __self: this
        },
        _custom.backLink
      )
    );
