...
function renderHighlighted(nodes) {
  return {
    __html: (0, _custom.postHighlight)((0, _remark2.default)().use(_remarkHtml2.default).stringify((0, _remark2.default)().use(_highlight2.default).run({
      type: 'root',
      children: nodes
    })))
  };
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      {
        ...
        className: 'keyline-top section contain clearfix ' + (preview ? 'preview' : ''), __self: this
      },
      _react2.default.createElement('div', {
        className: leftClassname,
        dangerouslySetInnerHTML: renderHighlighted(left), __self: this
      }),
      right.length > 0 && _react2.default.createElement('div', {
        className: rightClassname,
        dangerouslySetInnerHTML: renderHighlighted(right), __self: this
      })
    );
  }
});
